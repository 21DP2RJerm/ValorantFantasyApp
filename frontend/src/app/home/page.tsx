...
export default function Home() {
  ...
  return (
    <div className="relative flex justify-end items-center h-screen w-screen space bg-gray-900 pr-10">
      <Navigation />
      <div className="relative w-[60%] h-[60%] bg-purple-700 rounded-lg border-8 ml-10 border-white flex flex-col text-center">
        <p className="text-4xl text-white text-center font-bold pt-5">Welcome to the Fantasy Valorant League</p>
        <div className="flex flex-row text-center w-full justify-center ">
      ...
      <div className="relative w-[20%] h-[60%] bg-purple-700 rounded-lg border-8 ml-10 border-white flex flex-col">
        ...
        {games.length > 0 ? (
          games.map((game, index) => (
            <div
              key={game.id}
              className="relative w-full h-1/3 border-2 border-white flex flex-row items-center justify-between p-2"
            >
              ...
              <div className="flex flex-col items-center justify-center flex-1 px-4">
                ...
                <p className="text-sm text-white text-center font-bold">{tournament.name}</p>
                <p className="text-sm text-white text-center">{game.game_name}</p>
              </div>
              <div className="flex items-center justify-center">
                <Image
