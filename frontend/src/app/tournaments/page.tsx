                ...
                {tournaments.length > 0 ? (
                  tournaments.map((tournament) => (
                    ...
                    >
                      ...
                      <div className="w-full grid grid-cols-3 items-center px-6 relative z-20">
                        ...
                        <div className="flex justify-center">
                          <p className="text-white text-2xl font-bold text-center">{tournament.name}</p>
                        </div>
                
                        <div className="flex justify-end">
                          <p className="text-white text-2xl font-bold text-right">{tournament.location}</p>
                        </div>
                      </div>
                    </Link>
                  ))
